...
async function resetProducts() {
  ...
  await sql`
    ...
    ('Repollo Verde', 'Repollo verde fresco y crujiente ideal para ensaladas', 1600, 20, true, 'Verduras', 'https://images.unsplash.com/photo-1594282486552-05b4d80fbb9f?w=500&auto=format&fit=crop&q=60'),
    ...
    ('Plátano (1 Kg)', 'Plátanos maduros en su punto óptimo de dulzura', 1590, 40, true, 'Frutas', 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=500&auto=format&fit=crop&q=60'),
